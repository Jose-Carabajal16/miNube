...
router.post("/", async (req, res) => {
    ...
    try {
        ...
        let productoNuevo = await productManager.addProduct({ title, description, code, price, stock, thumbnails});
...
router.delete("/:id", async (req, res) => {
    ...
    try {
        ...
        if (productoEliminado) {
            console.log('Producto eliminado (en router):', productoEliminado); // <-- Verificar el objeto en la ruta
