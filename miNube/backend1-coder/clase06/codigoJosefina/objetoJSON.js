...
let leerHeroes = JSON.parse(fs.readFileSync(rutaArchivo, {encoding: "utf8"})) // → Convierte la cadena de texto obtenida de fs.readFileSync en un objeto JavaScript. Esto es necesario porque el contenido del archivo leído está en formato JSON, que es una cadena de texto que sigue una estructura específica (parecida a un objeto o arreglo en JavaScript).
console.log(leerHeroes)
console.log(typeof leerHeroes)
console.log(leerHeroes[0].alias)
